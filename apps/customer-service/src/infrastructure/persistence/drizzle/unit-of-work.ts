...
export class DrizzleUnitOfWork implements IUnitOfWorkPort {
  ...
  /* Serileştirme/deadlock hatalarında transaction baştan denenir; iş yükü
   * closure olduğu için her denemede güncel durumu yeniden okur. İç içe
   * çağrıda retry yapılmaz: dıştaki transaction PG tarafında zaten iptal
   * edilmiştir, tekrar dışarıdan gelir. */
